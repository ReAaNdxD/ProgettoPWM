...
public class Prodotto  implements java.io.Serializable {
    ...
    public Prodotto(Sottocategoria sottocategoria, String nome, String descrizioneBreve, String descrizioneDettagliata, String marca) {
    ...
    public Prodotto(Sottocategoria sottocategoria, String nome, String descrizioneBreve, String descrizioneDettagliata, String marca, Set articolos) {
       this.sottocategoria = sottocategoria;
       this.nome = nome;
       this.descrizioneBreve = descrizioneBreve;
       this.descrizioneDettagliata = descrizioneDettagliata;
