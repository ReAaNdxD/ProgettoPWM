...
public class Cliente  implements java.io.Serializable {
    ...
    public Cliente(String email, String password, String nome, String cognome, Date dataDiNascita, Clienteprime clienteprime, Set carrellos, Set indirizzospediziones, Set cartacreditos) {
       this.email = email;
       this.password = password;
       this.nome = nome;
       this.cognome = cognome;
