...
<meta charset="UTF-8">
<title>Crea Sottocategoria</title>
						...
						<div class="form-main">
							<div class="title">
								...
								<%
									...
									%>
									<h4>Sottocategoria già presente</h4>
								<%
								}
								%>
								<h3>Crea Sottocategoria</h3>
							</div>
							<form class="form" action="CreaSottocategoria" method="post">
								<div class="row">
									<div class="col-lg-7  col-12">
										...
										<%if(session.getAttribute("Categoria")==null) {%>
											...
											<select id="categoria" name="categoria" required > 	 
												...
												%>
												<label>Categoria <span>*</span></label><select id="categoria" name="categoria" required> 	 
												<option></option>
												<%
									...
									<div class="col-lg-7 col-12">
										<div class="form-group">
											<label>Sottocategoria<span>*</span></label> <input
												name="sottocategoria" type="text" id="sottocategoria"
									...
									<div class="col-12">
										<div class="form-group message">
											...
											<textarea id="area" name="descrizione" placeholder=""
									...
									<div class="col-12">
										<div class="form-group button">
											<button type="submit" class="btn ">Crea sottocategoria</button>
